 ...
 */
public class ResideMenuLayout extends ViewGroup {
    private static final String TAG = "ResideMenuLayout";
     ...
     */
    private int defaultOverhangSize = 60; // dp;
    ...
    protected boolean canScroll(View v, boolean checkV, int dx, int x, int y) {
        ...
        return checkV && ViewCompat.canScrollHorizontally(v, (isLayoutRtlSupport() ? dx : -dx)) || ((v instanceof ViewPager) && canViewPagerScrollHorizontally((ViewPager) v, -dx));
    }
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(ResideMenuLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(ResideMenuLayout parent, View child) {
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == ResideMenuLayout.this) {
    ...
    public void setDefaultOverhangSize(int overhangSize) {
        defaultOverhangSize = overhangSize;
    }
}
